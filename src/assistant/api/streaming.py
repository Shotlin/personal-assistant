...
async def sse_agent_stream(
    ...
    *,
    ...
    The terminal timeline event is marked in the generator's ``finally`` --
    after real completion/cleanup (master plan F06), not when the response
    object is created.
    """
    ...
    try:
        ...
        # (completion, timeout, error, or client disconnect).
